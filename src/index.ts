...
import { field as realField, date as realDate, subCollection as realSubCollection, object as realObject, array as realArray } from './decorators'
...
import { field as mokedField, date as mokedDate, subCollection as mokedSubCollection, object as mokedObject, array as mokedArray } from './moked/decorators'
...
const array = isMocked ? mokedArray : realArray

export { Collection, SubCollection, CollectionRepository, Instance, field, date, subCollection, object, array }
