...
export class Collection extends Instance {
  ...
  public static async findBy<T extends typeof Instance> (this: T, field: string, value: string | boolean | number): Promise<InstanceType<T>|undefined> { return await (new CollectionRepository<T>(this, null)).findBy(field, value) }
  public static async findByOrFail<T extends typeof Instance> (this: T, field: string, value: string | boolean | number, errorMessage?: string): Promise<InstanceType<T>> { return await (new CollectionRepository<T>(this, null)).findByOrFail(field, value, errorMessage) }
